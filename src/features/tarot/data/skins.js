...
export const TAROT_SKINS = Object.freeze([
  {
    ...
    preview: sitePath("assets/tarot/rws/major-17.jpg"),
    extension: "jpg",
  },
  {
    id: "marseille",
    ...
    preview: sitePath("assets/tarot/marseille/major-17.jpg"),
    extension: "jpg",
  },
]);
...
export function cardImage(cardId, skinId = "rws") {
  ...
  return sitePath(`assets/tarot/${skin.id}/${cardId}.${skin.extension}`);
}
